...
public class PostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button postButton = (Button) findViewById(R.id.btnPostEnd);
        Button getButton = (Button) findViewById(R.id.btnGetEnd);
        Button putButton = (Button) findViewById(R.id.btnPut);
        Button deleteButton = (Button) findViewById(R.id.btnDELETE);

        postButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
               // Intent postIntent = new Intent(PostActivity.this, .class);
